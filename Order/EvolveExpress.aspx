<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EvolveExpress.aspx.vb" Inherits="Order_EvolveExpress" MasterPageFile="~/Site.Master" Title="Evolve Ocean Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="/Scripts/RisaSolihah/EvolveExpress.js?v=1.0.0"></script>
</asp:Content>