...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                        ...
                                        <div id="divdetail">
                                            ...
                                            <div id="divtrackb">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-12 col-sm-12 col-lg-3 form-group">
                                                        <select id="trackdrawb" class="form-select"></select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="divfabricb">
                                            ...
                                            <div id="divreturnlengthb">
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-12 col-sm-12 col-lg-4 form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-text">Left</span>
                                                            <input type="number" id="returnlengthvaluec" class="form-control" autocomplete="off" placeholder=".... mm" />
                                                            <span class="input-group-text">mm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-12 col-lg-4 form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-text">Right</span>
                                                            <input type="number" id="returnlengthvalued" class="form-control" autocomplete="off" placeholder=".... mm" />
                                                            <span class="input-group-text">mm</span>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="/Scripts/RisaSolihah/Curtain.js?v=1.1.1"></script>
</asp:Content>
