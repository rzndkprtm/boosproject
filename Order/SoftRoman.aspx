<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SoftRoman.aspx.vb" Inherits="Order_SoftRoman" MasterPageFile="~/Site.master" Title="Soft Roman Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="/Scripts/RisaSolihah/SoftRoman.js?v=1.0.0"></script>
</asp:Content>