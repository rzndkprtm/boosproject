<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Upload.aspx.vb" Inherits="Order_Upload" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Upload Order" %>
            ...
            <div class="col-12 col-sm-12 col-lg-6 mb-2">
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        <asp:Button runat="server" ID="btnSubmit" CssClass="btn btn-primary" Text="Upload" OnClick="btnSubmit_Click" />
