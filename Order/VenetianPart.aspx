<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VenetianPart.aspx.vb" Inherits="Order_VenetianPart" MasterPageFile="~/Site.Master" Title="Venetian Part Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="form form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div id="divdetail">
                                            ...
                                            <div class="row" id="divvalancetype">
                                                <div class="col-12 col-sm-12 col-lg-3">
                                            ...
                                            <div class="row" id="divvalancesize">
                                                <div class="col-12 col-sm-12 col-lg-3">
                                                    <label>Valance Size</label>
                                                </div>
                                                <div class="col-12 col-sm-12 col-lg-4 form-group">
                                            ...
                                            <div class="row" id="divreturnposition">
                                                <div class="col-12 col-sm-12 col-lg-3">
    ...
    <script src="/Scripts/RisaSolihah/VenetianPart.js?v=1.0.2"></script>
</asp:Content>