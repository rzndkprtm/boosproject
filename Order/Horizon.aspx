<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Horizon.aspx.vb" Inherits="Order_Horizon" MasterPageFile="~/Site.Master" Title="Roller Horizon Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="/Scripts/RisaSolihah/Horizon.js?v=1.0.0"></script>
</asp:Content>