...
Partial Class Order_Detail
    ...
    Protected Sub btnConvertOrder_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As New SqlCommand("sp_OrderJobs_Insert", thisConn)
                    thisCmd.CommandType = CommandType.StoredProcedure
    ...
    Protected Sub BindDataCosting(itemCount As Integer)
        ...
        If lblCompanyId.Text = "2" Then
            If Session("RoleName") = "Developer" OrElse Session("RoleName") = "IT" OrElse Session("RoleName") = "Factory Office" OrElse Session("RoleName") = "Sales" Then
    ...
    Protected Function VisibleCosting() As Boolean
        ...
        If Session("RoleName") = "Developer" OrElse Session("RoleName") = "IT" OrElse Session("RoleName") = "Factory Office" OrElse Session("RoleName") = "Sales" OrElse Session("RoleName") = "Data Entry" OrElse Session("RoleName") = "Account" OrElse Session("RoleName") = "Export" Then result = True
