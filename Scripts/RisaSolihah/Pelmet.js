...
function controlForm(status, isEditItem, isCopyItem) {
    ...
    const inputs = ["blindtype", "tubetype", "colourtype", "qty", "room", "mounting", "fabrictype", "fabriccolour", "batten", "layoutcode", "width", "widthb", "widthc", "returnposition", "returnlengthvalue", "returnlengthvalueb", "supply", "notes", "markup"];
...
function process() {
    ...
    const fields = ["blindtype", "tubetype", "colourtype", "qty", "room", "mounting", "fabrictype", "fabriccolour", "batten", "layoutcode", "width", "widthb", "widthc", "returnposition", "returnlengthvalue", "returnlengthvalueb", "supply", "notes", "markup"];
