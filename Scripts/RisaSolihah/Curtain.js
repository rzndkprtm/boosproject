...
function bindColourType(blindType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "ProductName", companydetailid: companyDetailId, blindtype: blindType, tubetype: "9", controltype: "17", orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindTrackType(heading) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "CurtainTrackType", customtype: safeHeading, companydetailid: companyDetailId, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindTrackColour(trackType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "CurtainTrackColour", customtype: trackType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindTrackDraw(trackType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "CurtainTrackDraw", customtype: trackType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
    ...
    return new Promise((resolve) => {
        ...
        getBlindName(blindType).then(blindName => {
            ...
            if (blindName === "Complete Set (Single)") {
                ...
                if (companyId === "3") {
                    divShow.push("divcutlength", "divfullness");
                }
...
function process() {
    ...
    const fields = ["blindtype", "colourtype", "qty", "room", "mounting", "heading", "headingb", "fabrictype", "fabrictypeb", "fabriccolour", "fabriccolourb", "tracktype", "tracktypeb", "trackcolour", "trackcolourb", "trackdraw", "trackdrawb", "stackposition", "stackpositionb", "width", "widthb", "drop", "dropb", "cutlength", "controlcolour", "controlcolourb", "controllength", "controllengthb", "returnlengthvalue", "returnlengthvalueb", "returnlengthvaluec", "returnlengthvalued", "fullness", "bottomhem", "tieback", "notes", "markup"];
