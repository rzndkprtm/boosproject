...
function bindTubeType(blindType) {
    return new Promise((resolve, reject) => {
        ...
        let listData = { type: "TubeType", companydetailid: companyDetailId, blindtype: blindType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindColourType(blindType, tubeType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "ColourType", companydetailid: companyDetailId, blindtype: blindType, tubetype: tubeType, controltype: "17", orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindLayoutCode(tubeType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "LayoutCodeDoor", tubetype: tubeType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindMeshType(blindType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "MeshDoor", blindtype: blindType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindFrameColour(blindType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "FrameColourDoor", blindtype: blindType, companydetailid: companyDetailId, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindInterlock(tubeType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "InterlockDoor", tubetype: tubeType, orderstatus: orderStatus, rolename: roleAccess, action: itemAction };
...
function bindComponentForm(blindType, tubeType, colourType) {
    return new Promise((resolve) => {
        ...
        const divsToHide = ["divlayoutcode", "divmidrailposition", "divhandletype", "divhandlelength", "divtriplelock", "divbugseal", "divpetdoor", "divdoorcloser", "divangle", "divbeading", "divjambadaptor", "divflushbold", "divinterlocktype", "divtoptrack", "divbottomtrack", "divreceiver", "divslidingqty"].map(id => document.getElementById(id));
...
function controlForm(status, isEditItem, isCopyItem) {
    ...
    const inputs = ["blindtype", "tubetype", "colourtype", "qty", "room", "mounting", "width", "widthb", "widthc", "drop", "meshtype", "framecolour", "layoutcode", "midrailposition", "handletype", "handlelength", "triplelock", "bugseal", "pettype", "petposition", "doorcloser", "angletype", "anglelength", "beading", "jambtype", "jambposition", "flushbold", "interlocktype", "toptrack", "toptracklength", "bottomtrack", "bottomtracklength", "receivertype", "receiverlength", "slidingqty", "notes", "markup"];
...
function process() {
    ...
    const fields = ["blindtype", "tubetype", "colourtype", "qty", "room", "mounting", "width", "widthb", "widthc", "drop", "meshtype", "framecolour", "layoutcode", "midrailposition", "handletype", "handlelength", "triplelock", "bugseal", "pettype", "petposition", "doorcloser", "angletype", "anglelength", "beading", "jambtype", "jambposition", "flushbold", "interlocktype", "toptrack", "toptracklength", "bottomtrack", "bottomtracklength", "receivertype", "receiverlength", "slidingqty", "notes", "markup"];
