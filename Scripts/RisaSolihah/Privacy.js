...
function controlForm(status, isEditItem, isCopyItem) {
    ...
    const inputs = ["blindtype", "colourtype", "qty", "room", "mounting", "controlposition", "tilterposition", "width", "drop", "controllength", "controllengthvalue", "supply", "notes", "markup"];
...
function process() {
    ...
    const fields = ["blindtype", "colourtype", "qty", "room", "mounting", "controlposition", "tilterposition", "width", "drop", "controllength", "controllengthvalue", "supply", "notes", "markup"];
