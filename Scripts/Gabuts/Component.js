...
function bindColourType(blindType) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "ProductName", companydetailid: companyDetailId, blindtype: blindType, tubetype: "9", controltype: "17", action: itemAction };
...
function setFormValues(itemData) {
    const mapping = { blindtype: "BlindType", colourtype: "ProductId", qty="Qty", notes: "Notes"};
...
function process() {
    ...
    const fields = ["blindtype", "colourtype", "qty", "notes"];
    ...
    $.ajax({
        type: "POST",
        url: "Method.aspx/ServiceProcess",
