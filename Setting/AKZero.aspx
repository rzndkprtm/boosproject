<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AKZero.aspx.vb" Inherits="Setting_AKZero" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="AK Zero" %>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white">Delete AK Zero</h5>
                </div>
                <div class="modal-body">
