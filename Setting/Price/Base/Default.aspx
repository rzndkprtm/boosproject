                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="grid-container table-responsive">
                                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="true" CssClass="table table-bordered table-hover mb-0" ShowHeaderWhenEmpty="true" EmptyDataText="DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center"></asp:GridView>
                                    </div>
                                </div>
                            </div>
                        </div>
