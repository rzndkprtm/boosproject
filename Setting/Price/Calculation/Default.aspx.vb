...
Partial Class Setting_Price_Calculation_Default
    Inherits Page
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Session("SearchCalculation") = txtSearch.Text
        Response.Redirect("~/setting/price/calculation/add", False)
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        MessageError(False, String.Empty)
        Try
            Dim calculationId As String = txtDeleteId.Text

            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("DELETE FROM PriceCalculations WHERE Id=@Id; DELETE FROM Logs WHERE Type='PriceCalculations' AND DataId=@Id;", thisConn)
                    thisCmd.Parameters.AddWithValue("@Id", calculationId)
                    thisConn.Open()
