...
Partial Class Setting_Price_Product_Format_Default
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("SearchFormatProductGroup")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/setting/price/product/format/add", False)
    End Sub
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_PriceProductGroupFormats_List", params)
            gvList.DataBind()
