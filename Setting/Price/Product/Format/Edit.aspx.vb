...
Partial Class Setting_Price_Product_Format_Edit
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If String.IsNullOrEmpty(Request.QueryString("formatid")) Then
            Response.Redirect("~/setting/price/product/format", False)
            Exit Sub
        End If

        lblId.Text = Request.QueryString("formatid").ToString()
    ...
    Protected Sub BindData(formatId As String)
        Try
            Dim myData As DataRow = settingClass.GetDataRow("SELECT * FROM PriceProductGroupFormats WHERE Id='" & formatId & "'")
            ...
            txtFormat.Text = myData("Format").ToString()
