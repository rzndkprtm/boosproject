...
Partial Class Setting_Job_Order_Default
    Inherits Page
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("DELETE FROM OrderJobDetails WHERE OrderJobId=@Id; DELETE FROM OrderJobs WHERE Id=@Id; UPDATE OrderHeaders SET OrderJobId=NULL WHERE OrderJobId=@Id;", thisConn)
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            Dim thisData As DataTable = jobClass.GetDataTableSP("sp_OrderJobs_List", params)
