<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="Setting_Validation_Edit" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Edit Validation" %>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtErrorMessage" CssClass="form-control" placeholder="Error Message ..." autocomplete="off"></asp:TextBox>
                                        </div>
                                    </div>
