...
Partial Class Setting_Login_Role_Default
    Inherits Page
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/setting/login/role/add", False)
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As New SqlCommand("UPDATE LoginRoles SET Status='Deleted', Name=CASE WHEN Name LIKE '%(DELETED)%' THEN Name ELSE Name + ' (DELETED)' END WHERE Id=@Id", thisConn)
            ...
            dataLog = {"LoginRoles", thisId, Session("LoginId").ToString(), "Role Access Deleted"}
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_LoginRoles_List", params)
            gvList.DataBind()
