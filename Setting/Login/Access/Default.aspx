<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Login_Access_Default" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Login Access" %>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-lg-6 mb-2">
                                            <h4 class="card-title">List Access</h4>
                                        </div>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li runat="server" visible='<%# LoginAccess("Detail") %>'>
                                                                <a class="dropdown-item" id="aEdit" href='<%# Page.ResolveUrl("~/setting/login/access/edit?accessid=" & Eval("Id").ToString()) %>'>Edit</a>
                                                            </li>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white">Delete Access</h5>
                </div>
