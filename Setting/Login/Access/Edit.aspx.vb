...
Partial Class Setting_Login_Access_Edit
    ...
    Protected Sub BindRole()
        ...
        Try
            ddlRoleId.DataSource = settingClass.GetDataTable("SELECT Id, Name FROM LoginRoles WHERE Status='Active' OR Status='Inactive' ORDER BY Name ASC")
    ...
    Protected Sub BindLevel()
        ...
        Try
            ddlLevelId.DataSource = settingClass.GetDataTable("SELECT Id, Name FROM LoginLevels WHERE Status='Active' OR Status='Inactive' ORDER BY Name ASC")
