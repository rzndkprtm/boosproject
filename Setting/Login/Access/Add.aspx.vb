...
Partial Class Setting_Login_Access_Add
    Inherits Page
    ...
    Protected Sub BindRole()
        ...
        Try
            ddlRoleId.DataSource = settingClass.GetDataTable("SELECT Id, Name FROM LoginRoles WHERE Status='Active' ORDER BY Name ASC")
    ...
    Protected Sub BindLevel()
        ...
        Try
            ddlLevelId.DataSource = settingClass.GetDataTable("SELECT Id, Name FROM LoginLevels WHERE Status='Active' ORDER BY Name ASC")
