...
Partial Class Setting_Login_Level_Default
    Inherits Page
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/setting/login/level/add", False)
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As New SqlCommand("UPDATE LoginLevels SET Status='Deleted', Name=CASE WHEN Name LIKE '%(DELETED)%' THEN Name ELSE Name + ' (DELETED)' END WHERE Id=@Id", thisConn)
            ...
            dataLog = {"LoginLevels", thisId, Session("LoginId").ToString(), "Level Access Deleted"}
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_LoginLevels_List", params)
            gvList.DataBind()
