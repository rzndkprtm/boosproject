<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Login_Level_Default" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Login Level" %>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li runat="server" visible='<%# (If(Eval("Status"), "").ToString() = "Active" OrElse If(Eval("Status"), "").ToString() = "Inactive") AndAlso LoginAccess("Edit") %>'>
                                                            <a class="dropdown-item" id="aEdit" href='<%# Page.ResolveUrl("~/setting/login/level/edit?levelid=" & Eval("Id")) %>'>Edit</a>
                                                        </li>
