...
Partial Class Setting_Login_User_Installer_Add
    ...
    Protected Sub BindInstaller()
        ...
        Try
            ddlLogin.DataSource = settingClass.GetDataTable("SELECT Id, FullName FROM Logins WHERE RoleId='10' AND Status='Active' ORDER BY FullName ASC")
    ...
    Protected Sub BindCustomer()
        ...
        Try
            lbCustomer.DataSource = settingClass.GetDataTable("SELECT Id, Name FROM Customers WHERE Status='Active' AND CompanyDetailId='3' ORDER BY Name ASC")
