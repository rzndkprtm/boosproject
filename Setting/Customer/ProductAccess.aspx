...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="gvList" CssClass="table table-bordered table-hover mb-0" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="DATA NOT FOUND :)" PageSize="50" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" OnRowCommand="gvList_RowCommand" OnPageIndexChanging="gvList_PageIndexChanging">
                                            <RowStyle />
                                            <Columns>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <div class="col-12 form-group">
                            ...
                            <asp:ListBox runat="server" ID="lbProduct" CssClass="choices form-select multiple-remove" SelectionMode="Multiple"></asp:ListBox>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        ["modalLog", "modalProcess", "modalReset"].forEach(function (id) {
