...
Partial Class Setting_Customer_Contact_Default
    Inherits Page
    ...
    Protected Sub btnPrimary_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("UPDATE CustomerContacts SET [Primary]=0 WHERE CustomerId=@CustomerId; UPDATE CustomerContacts SET Tags='Confirming,Invoicing,Quoting,Newsletter', [Primary]=1 WHERE Id=@Id;", thisConn)
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_CustomerContacts_List", params)
            gvList.DataBind()
