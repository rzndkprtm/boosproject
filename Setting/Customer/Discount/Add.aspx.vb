        ...
        Try
            ...
            If msgError.InnerText = "" Then
                ...
                If ddlType.SelectedValue = "Designs" Then
                    Dim companyId As String = settingClass.GetItemData("SELECT CompanyId FROM Customers WHERE Id='" & ddlCustomer.SelectedValue & "'")
                    sql = "SELECT Id FROM Designs CROSS APPLY STRING_SPLIT(CompanyId, ',') AS companyArray CROSS APPLY STRING_SPLIT(AppliesTo, ',') AS applyArray WHERE applyArray.VALUE='Discounts' AND companyArray.VALUE='" & companyId & "' ORDER BY Id ASC"
                End If
