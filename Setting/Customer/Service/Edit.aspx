<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="Setting_Customer_Service_Edit" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Edit Customer Service" %>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-12 form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlService" CssClass="choices form-select"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row" runat="server" id="divDefaultPrice">
                                     <div class="col-12 col-sm-12 col-lg-4 form-group">
                                ...
                                <div class="row" runat="server" id="divFormulaValue">
                                    <div class="col-12 col-sm-12 col-lg-4 form-group">
