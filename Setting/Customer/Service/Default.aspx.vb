...
Partial Class Setting_Customer_Service_Default
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("SearchCustomerService")
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        ...
        Session("SearchCustomerService") = txtSearch.Text
    End Sub

    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Session("SearchCustomerService") = txtSearch.Text
        Response.Redirect("~/setting/customer/service/add", False)
    End Sub
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_CustomerServices_List", params)
            gvList.DataBind()
