<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Multiple.aspx.vb" Inherits="Setting_Customer_Multiple" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Multiple Change Customer" %>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-12 form-group">
                                                ...
                                                <asp:ListBox runat="server" ID="lbNewData" CssClass="choices form-select multiple-remove" SelectionMode="Multiple"></asp:ListBox>
                                            </div>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
