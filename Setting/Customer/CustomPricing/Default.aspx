<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Customer_CustomPricing_Default" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Customer Custom Pricing" %>
                            ...
                            <div class="card-header">
                                <div class="row g-2 align-items-center">
                                    <div class="col-12 col-sm-12 col-lg-6">
                                        <h5 class="card-title">List Custom Pricing</h5>
                                    </div>
                                    <div class="col-12 col-sm-12 col-lg-6">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li runat="server" visible='<%# LoginAccess("Edit") %>'>
                                                            <a class="dropdown-item" id="aEdit" href='<%# Page.ResolveUrl("~/setting/customer/custompricing/edit?customid=" & Eval("Id")) %>'>Edit</a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);" class="dropdown-item" onclick="showLog('CustomerCustomPricings', '<%# Eval("Id") %>')">Log</a>
                                                        </li>
                                                    </ul>
                                                </ItemTemplate>
                                            </asp:TemplateField>
