...
Partial Class Setting_Customer_CustomPricing_Default
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("SearchCustomerCustom")
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        ...
        Session("SearchCustomerCustom") = txtSearch.Text
    End Sub

    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Session("SearchCustomerCustom") = txtSearch.Text
        Response.Redirect("~/setting/customer/custompricing/add", False)
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("DELETE FROM Logs WHERE Type='CustomerCustomPricings' AND DataId=@Id; DELETE FROM CustomerCustomPricings WHERE Id=@Id", thisConn)
