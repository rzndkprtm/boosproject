...
Partial Class Setting_Customer_Business_Default
    ...
    Protected Sub btnPrimary_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("UPDATE CustomerBusiness SET [Primary]=0 WHERE CustomerId=@CustomerId; UPDATE CustomerBusiness SET [Primary]=1 WHERE Id=@Id", thisConn)
    ...
    Protected Sub BindData(searchText As String)
        Try
            ...
            gvList.DataSource = settingClass.GetDataTableSP("sp_CustomerBusiness_List", params)
            gvList.DataBind()
