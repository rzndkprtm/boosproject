<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoginAccess.aspx.vb" Inherits="Setting_General_LoginAccess" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Login Access" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content text-justify">
                                <div class="tab-pane fade show active" id="list-role" role="tabpanel" aria-labelledby="listRole">
                                    <div class="row mt-5" runat="server" id="divErrorRole">
                                        <div class="col-12">
                                            <div class="alert alert-danger">
                                                <span runat="server" id="msgErrorRole"></span>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li runat="server" visible='<%# PageAction("Detail") %>'>
                                                                        <asp:LinkButton runat="server" ID="linkDetailRole" CssClass="dropdown-item" Text="Detail / Edit" CommandName="Detail" CommandArgument='<%# Eval("Id") %>'></asp:LinkButton>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)" class="dropdown-item" onclick="showLog('LoginRoles', '<%# Eval("Id") %>')">Log</a>
                                                                    </li>
                                                                </ul>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                ...
                                <div class="tab-pane fade" id="list-level" role="tabpanel" aria-labelledby="listLevel">
                                    <div class="row mt-5">
                                        <div class="col-12" runat="server" id="divErrorLevel">
                                             <div class="col-12">
                                                 <div class="alert alert-danger">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                <asp:GridView runat="server" ID="gvListLevel" CssClass="table table-bordered table-hover mb-0" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="DATA NOT FOUND :)" PageSize="50" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvListLevel_PageIndexChanging" OnRowCommand="gvListLevel_RowCommand">
                                                    <RowStyle />
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="180px">
                                                            <ItemTemplate>
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li runat="server" visible='<%# PageAction("Detail") %>'>
                                                                        <asp:LinkButton runat="server" ID="linkDetailLevel" CssClass="dropdown-item" Text="Detail / Edit" CommandName="Detail" CommandArgument='<%# Eval("Id") %>'></asp:LinkButton>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)" class="dropdown-item" onclick="showLog('LoginLevels', '<%# Eval("Id") %>')">Log</a>
                                                                    </li>
                                                                </ul>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            const gridConfigs = [
                { id: '<%= gvListRole.ClientID %>', link: "linkDetailRole" },
                { id: '<%= gvListLevel.ClientID %>', link: "linkDetailLevel" }
            ];
        ...
        $(document).ready(function () {
            ...
            var tabId = selectedTab.val() != "" ? selectedTab.val() : "list-role";
            $('#dvTab a[href="#' + tabId + '"]').tab('show');
            $("#dvTab a").click(function () {
                selectedTab.val($(this).attr("href").substring(1));
            });

            $("#listRole").on("click", function () {
                updateSessionValue("list-role");
            });
            $("#listLevel").on("click", function () {
                updateSessionValue("list-level");
            });
        });
