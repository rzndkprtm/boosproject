...
Partial Class Setting_General_Notification_Edit
        ...
        Try
            ...
            If msgError.InnerText = "" Then
                ...
                Using thisConn As New SqlConnection(myConn)
                    Using thisCmd As SqlCommand = New SqlCommand("UPDATE Notifications SET RoleId=@RoleId, CompanyId=@CompanyId, LoginId=@LoginId, Title=@Title, Message=@Message, StartDate=@StartDate, EndDate=@EndDate, Active=@Active WHERE Id=@Id; DELETE FROM NotificationLogs WHERE NotificationId=@Id;", thisConn)
    ...
    Protected Sub BindLoginRole()
        ...
        Try
            ddlLoginRole.DataSource = settingClass.GetDataTable("SELECT * FROM LoginRoles WHERE Status='Active' OR Status='Inactive' ORDER BY Name ASC")
    ...
    Protected Sub BindCompany()
        ...
        Try
            ddlCompany.DataSource = settingClass.GetDataTable("SELECT * FROM Companys WHERE Status='Active' OR Status='Inactive' ORDER BY Name ASC")
