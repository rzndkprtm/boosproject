<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View.aspx.vb" Inherits="Setting_Database_View" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="View" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="180px">
                                                    <ItemTemplate>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <asp:LinkButton runat="server" ID="linkDetail" CssClass="dropdown-item" Text="Detail / Edit" CommandName="Detail" CommandArgument='<%# Eval("ViewName").ToString() %>'></asp:LinkButton>
                                                            </li>
                                                        </ul>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 form-group">
                            ...
                            <asp:TextBox runat="server" TextMode="MultiLine" ID="txtQuery" Height="550px" CssClass="form-control" placeholder="Query ..." autocomplete="off" style="resize:none;"></asp:TextBox>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        ["modalProcess"].forEach(function (id) {
