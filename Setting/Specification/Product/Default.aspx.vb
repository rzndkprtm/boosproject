...
Partial Class Setting_Specification_Product_Default
    ...
    Protected Sub btnCopy_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using thisCmd As SqlCommand = New SqlCommand("INSERT INTO Products SELECT @NewId, Type, DesignId, BlindId, CompanyDetailId, JobSheetId, Name + ' - Copy', InvoiceName, TubeType, ControlType, ColourType, Description, NULL FROM Products WHERE Id=@Id", thisConn)
