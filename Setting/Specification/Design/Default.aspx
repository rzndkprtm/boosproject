<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Specification_Design_Default" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Design Type" %>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-lg-6 mb-2">
                                        <h4 class="card-title">Design Type List</h4>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView runat="server" ID="gvList" CssClass="table table-bordered table-hover mb-0" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="DATA NOT FOUND :)" PageSize="50" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Visible="false" OnPageIndexChanging="gvList_PageIndexChanging" OnDataBound="gvList_DataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CompanyAlias" HeaderText="Company Name" />
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li runat="server" visible='<%# LoginAccess("Detail") %>'>
                                                            <a class="dropdown-item" id="aDetail" href='<%# Page.ResolveUrl("~/setting/specification/design/edit?designid=" & Eval("Id")) %>'>Detail / Edit</a>
                                                        </li>
                                                        <li>
