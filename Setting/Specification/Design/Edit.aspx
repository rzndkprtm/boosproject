<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="Setting_Specification_Design_Edit" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Edit Design Type" %>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a runat="server" href="~/setting/specification/design">Design</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-7">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Design Type Form</h4>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-group">
                                            ...
                                            <asp:ListBox runat="server" ID="lbApplies" CssClass="choices form-select multiple-remove" SelectionMode="Multiple">
                                                ...
                                                <asp:ListItem Value="Markups" Text="Markups"></asp:ListItem>
