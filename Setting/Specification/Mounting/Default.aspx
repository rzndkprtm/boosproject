<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Specification_Mounting_Default" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Mounting" %>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li runat="server" visible='<%# LoginAccess("Detail") %>'>
                                                            <a class="dropdown-item" id="aDetail" href='<%# Page.ResolveUrl("~/setting/specification/mounting/edit?mountingid=" & Eval("Id")) %>'>Detail / Edit</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);" class="dropdown-item" onclick="showLog('Mountings', '<%# Eval("Id") %>')">Log</a>
                                                        </li>
                                                    </ul>
                                                </ItemTemplate>
                                            </asp:TemplateField>
