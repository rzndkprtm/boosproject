        ...
        If Not String.IsNullOrEmpty(status) Then
            ...
            If headerData.Rows.Count > 0 Then
                For i As Integer = 0 To headerData.Rows.Count - 1
                    ...
                    'ORDER DETAIL
                    Dim detailData As DataTable = archiveClass.GetDataTable("SELECT * FROM BuilderDetails WHERE FKOrdID='" & ordId & "' AND Active=1 ORDER BY OrddID ASC")
