...
Public Class PreviewClass
    ...
    Public Function BindContent(headerId As String) As Byte()
        Using ms As New MemoryStream()
            ...
            Try
                ...
                If curtainData.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To curtainData.Rows.Count - 1
                        ...
                        Dim rlLeft As String = String.Empty
                        Dim rlRight As String = String.Empty

                        If Convert.ToDecimal(If(IsDBNull(curtainData.Rows(i)("RetLengthLeft")), 0, curtainData.Rows(i)("RetLengthLeft"))) <> 0 Then
                            rlLeft = curtainData.Rows(i)("RetLengthLeft").ToString()
                        End If

                        If Convert.ToDecimal(If(IsDBNull(curtainData.Rows(i)("RetLengthRight")), 0, curtainData.Rows(i)("RetLengthRight"))) <> 0 Then
                            rlRight = curtainData.Rows(i)("RetLengthRight").ToString()
                        End If
            ...
            Try
                ...
                If lineaData.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To lineaData.Rows.Count - 1
                        ...
                        If returnLength = "Standard" OrElse returnLength = "Custom" Then
            ...
            Try
                ...
                If romanData.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To romanData.Rows.Count - 1
                        ...
                        Dim controlLengthText As String = controlLength
                        If controlLength = "Standard" OrElse controlLength = "Custom" Then
                            controlLengthText = String.Format("{0} : {1}mm", controlLength, controlLengthValue)
                        End If
            ...
            Try
                ...
                If venetianData.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To venetianData.Rows.Count - 1
                        ...
                        Dim wandLength As String = venetianData.Rows(i)("WL").ToString()
                        Dim wandLengthValue As String = venetianData.Rows(i)("WLValue").ToString()

                        Dim wandLengthText As String = String.Empty
                        If Not String.IsNullOrEmpty(wandLength) Then
                            wandLengthText = String.Format("{0} : {1}mm", wandLength, wandLengthValue)
                        End If
            ...
            ' START ALUMINIUM PART
            Try
                Dim params As New List(Of SqlParameter) From {
                    New SqlParameter("@HeaderId", headerId)
                }
                Dim aluminiumPartData As DataTable = GetDataTableSP("sp_OrderDetails_Get_AluminiumPart", params)
                ...
                If aluminiumPartData.Rows.Count > 0 Then
                    ...
                    Dim items(5, aluminiumPartData.Rows.Count - 1) As String

                    For i As Integer = 0 To aluminiumPartData.Rows.Count - 1
                        Dim number As Integer = i + 1

                        Dim wandLength As String = aluminiumPartData.Rows(i)("WandLength").ToString()
                        Dim wandLengthValue As String = aluminiumPartData.Rows(i)("WandLengthValue").ToString()
                        ...
                        items(3, i) = wandLengthText
                        items(4, i) = aluminiumPartData.Rows(i)("Notes").ToString()
                    Next
                    ...
                    For i As Integer = 0 To items.GetLength(1) - 1 Step 4
                        ...
                        Dim headers As String() = {"", "Type", "Product", "Wand Length", "Special Information"}
