...
Public Class ShutterOceanService
    ...
    'Public Async Function PreviewJsonAsync(headerId As String) As Task(Of String)
    '    Dim payload = Await BuildPayloadAsync(headerId)
    '    Return JsonConvert.SerializeObject(payload, Formatting.Indented)
    'End Function

    'Public Async Function SendOrderAsync_Try(headerId As String) As Task
    '    Dim payload = Await BuildPayloadAsync(headerId)
    ...
    'Private Async Function BuildPayloadAsync(headerId As String) As Task(Of DataHeader)
    ...
    '                payload.OrderNumber = rd("OrderId").ToString()
    '                payload.OrderName = rd("CustomerName").ToString()
    ...
    Public Async Function SendOrderAsync(headerId As String) As Task
        ...
        Using conn As New SqlConnection(ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString)
            ...
            Dim cmdHeader As New SqlCommand("SELECT OrderHeaders.Id, OrderHeaders.OrderId, OrderHeaders.OrderNote, Customers.Name AS CustomerName FROM OrderHeaders LEFT JOIN Customers ON OrderHeaders.CustomerId=Customers.Id WHERE OrderHeaders.Id=@Id", conn)
            cmdHeader.Parameters.AddWithValue("@Id", headerId)
