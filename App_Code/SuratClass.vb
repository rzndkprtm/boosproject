...
Public Class SuratClass
    ...
    Public Function BindContent(headerId As String) As Byte()
        Using ms As New MemoryStream()
            ...
            Dim todayString As String = Date.Now.ToString("dd MMM yyyy")
            ...
            writer.PageEvent = New SuratEvents()
            ...
            alamatPengirim &= "Kareo, Serang, Banten 42177"
            ...
            rightTable.SetWidths({0.3F, 0.03F, 0.67F})
            ...
            rightTable.AddCell(CreateCell("Order Name", alignV:=Element.ALIGN_TOP))
            rightTable.AddCell(CreateCell(":", alignV:=Element.ALIGN_TOP))
            rightTable.AddCell(CreateCell(orderName, alignV:=Element.ALIGN_TOP))
